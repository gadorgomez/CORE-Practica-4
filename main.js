...
let main = async () => {
    ...
    try {
        ...
        //extra
        console.log('Ciudades más cálidas que ${temp}:', citiesWarmerThanTemp(cities, temp));
        console.log('Ciudad con mayor diferencia de temp y feels_like:', ciudadGreatestTempDiff(cities));
    } catch (error) {
        console.log(error);
    }
}
